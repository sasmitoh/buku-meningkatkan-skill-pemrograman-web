...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render('index', [
            ...
            'dataProduk' => $dataProvider->models,
        ]);
    }

    public function actionPakaianPria()
    {
        $searchModel = new ProdukSearch();
        //id 2 itu untuk kategori pakain wanita
    ...
    public function actionPakaianWanita()
    {
        $searchModel = new ProdukSearch();
        //id 2 itu untuk kategori pakain wanita
